...
vim.api.nvim_exec(
    "let startify_bookmarks = [{ 'a': '~/.config/alacritty/alacritty.yml' }, { 'i': '~/.config/nvim/init.lua' }, { 'z': '~/.zshrc' }, { 'd': '~/.dotfileslist' },{ 'o': '~/thread-box/.obsidian.vimrc' }, {'t' : '/home/dannydies/.config/qtile/config.py'}, {'v' : '/home/dannydies/.config/vifm/vifmrc'}, ]", true)
